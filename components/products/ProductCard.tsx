...
const koCopy: Record<string, ProductCopy> = {
  ...
  "medical-treatment-platform": {
    category: "고양 의료기관 안내", categorySummary: "종합병원 안내", tag: "종합병원",
    title: "고양시 종합병원 정보 안내",
    summary: "고양시 종합병원 및 전문 의료기관 정보를 안내합니다.",
  ...
  "medical-beauty-platform": {
    category: "고양 의료기관 안내", categorySummary: "미용의료 안내", tag: "미용의료",
    title: "고양시 미용의료 정보 안내",
    summary: "고양시 미용의료 시설 정보를 안내합니다.",
  ...
  "medical-recovery-platform": {
    category: "고양 의료기관 안내", categorySummary: "재활의료 안내", tag: "재활의료",
    title: "고양시 재활의료 정보 안내",
    summary: "고양시 재활의료 시설 정보를 안내합니다.",
...
const enCopy: Record<string, ProductCopy> = {
  "tour-experience-platform": {
    ...
    title: "Goyang Travel Guide Platform",
  ...
  "stay-reservation-platform": {
    ...
    title: "Goyang Stay Guide Platform",
  ...
  "restaurant-booking-platform": {
    ...
    title: "Goyang Restaurant Guide Platform",
  ...
  "medical-treatment-platform": {
    category: "Goyang Healthcare Guide", categorySummary: "General hospitals", tag: "Hospital",
    title: "Goyang General Hospital Guide",
    summary: "Information on general hospitals and specialty clinics in Goyang.",
  ...
  "medical-beauty-platform": {
    category: "Goyang Healthcare Guide", categorySummary: "Aesthetic medicine", tag: "Aesthetic",
    title: "Goyang Aesthetic Clinic Guide",
    summary: "Information on aesthetic medicine facilities in Goyang.",
  ...
  "medical-recovery-platform": {
    category: "Goyang Healthcare Guide", categorySummary: "Rehabilitation care", tag: "Rehab",
    title: "Goyang Rehabilitation Care Guide",
    summary: "Information on rehabilitation care facilities in Goyang.",
...
const jaCopy: Record<string, ProductCopy> = {
  ...
  "medical-treatment-platform": {
    category: "高陽 医療機関ガイド", categorySummary: "総合病院ご案内", tag: "総合病院",
    title: "高陽市 総合病院ご案内",
    summary: "高陽市の総合病院および専門医療機関の情報をご案内します。",
    duration: "各医療機関ご案内", people: "各医療機関ご案内", location: "高陽市の大学病院・専門医療機関",
    subcategories: ["総合診療", "専門診療", "健康検診"], priceLabel: "各医療機関へお問い合わせ",
  },
  "medical-beauty-platform": {
    category: "高陽 医療機関ガイド", categorySummary: "美容医療ご案内", tag: "美容医療",
    title: "高陽市 美容医療ご案内",
    summary: "高陽市の美容医療施設の情報をご案内します。",
    duration: "各医療機関ご案内", people: "各医療機関ご案内", location: "高陽市の美容医療施設",
    subcategories: ["美容医療", "皮膚医療", "ウェルネス"], priceLabel: "各医療機関へお問い合わせ",
  },
  "medical-recovery-platform": {
    category: "高陽 医療機関ガイド", categorySummary: "リハビリ医療ご案内", tag: "リハビリ",
    title: "高陽市 リハビリ医療ご案内",
    summary: "高陽市のリハビリ医療施設の情報をご案内します。",
...
const zhCNCopy: Record<string, ProductCopy> = {
  ...
  "medical-treatment-platform": {
    category: "高阳医疗机构信息", categorySummary: "综合医院信息", tag: "综合医院",
    title: "高阳市综合医院信息指南",
    summary: "介绍高阳市综合医院与专业医疗机构信息。",
    duration: "各医疗机构信息", people: "各医疗机构信息", location: "高阳市大学医院与专业医疗机构",
    subcategories: ["综合诊疗", "专业诊疗", "健康检查"], priceLabel: "请咨询各医疗机构",
  },
  "medical-beauty-platform": {
    category: "高阳医疗机构信息", categorySummary: "美容医疗信息", tag: "美容医疗",
    title: "高阳市美容医疗信息指南",
    summary: "介绍高阳市美容医疗设施信息。",
    duration: "各医疗机构信息", people: "各医疗机构信息", location: "高阳市美容医疗设施",
    subcategories: ["美容医疗", "皮肤医疗", "康养"], priceLabel: "请咨询各医疗机构",
  },
  "medical-recovery-platform": {
    category: "高阳医疗机构信息", categorySummary: "康复医疗信息", tag: "康复医疗",
    title: "高阳市康复医疗信息指南",
    summary: "介绍高阳市康复医疗设施信息。",
...
const zhTWCopy: Record<string, ProductCopy> = {
  ...
  "medical-treatment-platform": {
    category: "高陽醫療機構資訊", categorySummary: "綜合醫院資訊", tag: "綜合醫院",
    title: "高陽市綜合醫院資訊指南",
    summary: "介紹高陽市綜合醫院與專業醫療機構資訊。",
    duration: "各醫療機構資訊", people: "各醫療機構資訊", location: "高陽市大學醫院與專業醫療機構",
    subcategories: ["綜合診療", "專業診療", "健康檢查"], priceLabel: "請洽詢各醫療機構",
  },
  "medical-beauty-platform": {
    category: "高陽醫療機構資訊", categorySummary: "美容醫療資訊", tag: "美容醫療",
    title: "高陽市美容醫療資訊指南",
    summary: "介紹高陽市美容醫療設施資訊。",
    duration: "各醫療機構資訊", people: "各醫療機構資訊", location: "高陽市美容醫療設施",
    subcategories: ["美容醫療", "皮膚醫療", "養生"], priceLabel: "請洽詢各醫療機構",
  },
  "medical-recovery-platform": {
    category: "高陽醫療機構資訊", categorySummary: "復健醫療資訊", tag: "復健醫療",
    title: "高陽市復健醫療資訊指南",
    summary: "介紹高陽市復健醫療設施資訊。",
