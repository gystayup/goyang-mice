...
const sectionCopy: Record<LocaleKey, SectionCopy> = {
  ko: {
    ...
    cards: [
      ...
      { tag: "Guide", title: "지역 서비스 안내", desc: "여행상품, 숙박, 음식점, 티켓, 공항픽업까지 고양의 지역 정보를 한눈에 확인할 수 있습니다.", point: "카테고리별 안내와 흐름", href: "/products", gradientFrom: "#fff6f2", gradientTo: "#ffe7df", chip: "bg-[#ffd9cd] text-[#a34d36]", iconBg: "bg-[#ffd0c0]", iconColor: "text-[#9b3a1a]", glowColor: "rgba(255,143,126,0.5)", icon: ShoppingBag },
  ...
  en: {
    ...
    cards: [
      ...
      { tag: "Guide", title: "Local Services", desc: "Browse stays, travel products, dining, tickets and airport access — Goyang's local information at a glance.", point: "Category guides and flow", href: "/products", gradientFrom: "#fff6f2", gradientTo: "#ffe7df", chip: "bg-[#ffd9cd] text-[#a34d36]", iconBg: "bg-[#ffd0c0]", iconColor: "text-[#9b3a1a]", glowColor: "rgba(255,143,126,0.5)", icon: ShoppingBag },
  ...
  ja: {
    ...
    cards: [
      ...
      { tag: "Guide", title: "地域サービス案内", desc: "旅行商品・宿泊・レストラン・チケット・空港送迎まで高陽の地域情報をひとまとめでご確認いただけます。", point: "カテゴリー別案内と流れ", href: "/products", gradientFrom: "#fff6f2", gradientTo: "#ffe7df", chip: "bg-[#ffd9cd] text-[#a34d36]", iconBg: "bg-[#ffd0c0]", iconColor: "text-[#9b3a1a]", glowColor: "rgba(255,143,126,0.5)", icon: ShoppingBag },
  ...
  "zh-CN": {
    ...
    cards: [
      ...
      { tag: "Guide", title: "本地服务指南", desc: "浏览旅游产品、住宿、餐厅、票务和机场接送——高阳本地信息一览无余。", point: "分类指南与流程", href: "/products", gradientFrom: "#fff6f2", gradientTo: "#ffe7df", chip: "bg-[#ffd9cd] text-[#a34d36]", iconBg: "bg-[#ffd0c0]", iconColor: "text-[#9b3a1a]", glowColor: "rgba(255,143,126,0.5)", icon: ShoppingBag },
  ...
  "zh-TW": {
    ...
    cards: [
      ...
      { tag: "Guide", title: "在地服務指南", desc: "瀏覽旅遊產品、住宿、餐廳、票務和機場接送——高陽在地資訊一目瞭然。", point: "分類指南與流程", href: "/products", gradientFrom: "#fff6f2", gradientTo: "#ffe7df", chip: "bg-[#ffd9cd] text-[#a34d36]", iconBg: "bg-[#ffd0c0]", iconColor: "text-[#9b3a1a]", glowColor: "rgba(255,143,126,0.5)", icon: ShoppingBag },
