...
const sectionCopy: Record<LocaleKey, SectionCopy> = {
  ko: {
    eyebrow: "왜 서울이 아니라 고양인가 — 자연·역사·K컬처가 만나는 도시",
    title: "고양에서 무엇을 만날까",
    viewDetails: "자세히 보기",
    cards: [
      { tag: "Guide", title: "경험·볼거리 안내", desc: "여행상품, 숙박, 음식점, 티켓, 공항픽업까지 고양의 지역 정보를 한눈에 확인할 수 있습니다.", point: "호수·킨텍스·문화·역사를 한 흐름으로", href: "/products", gradientFrom: "#fff6f2", gradientTo: "#ffe7df", chip: "bg-[#ffd9cd] text-[#a34d36]", iconBg: "bg-[#ffd0c0]", iconColor: "text-[#9b3a1a]", glowColor: "rgba(255,143,126,0.5)", icon: ShoppingBag },
      { tag: "MICE", title: "MICE 안내", desc: "행사 운영과 로컬 경험을 연결하는 MICE 안내 구조를 바로 확인할 수 있습니다.", point: "현장 운영과 로컬 연결", href: "/dmc", gradientFrom: "#f0f4ff", gradientTo: "#eef2ff", chip: "bg-[#e1e8ff] text-[#3655a6]", iconBg: "bg-[#d4ddff]", iconColor: "text-[#3655a6]", glowColor: "rgba(100,130,255,0.4)", icon: Compass },
  ...
  en: {
    eyebrow: "Why Goyang, not Seoul — where nature, history and K-Culture meet",
    title: "What You'll Discover in Goyang",
    viewDetails: "View details",
    cards: [
      { tag: "Guide", title: "Experiences & Sights", desc: "Browse stays, travel products, dining, tickets and airport access — Goyang's local information at a glance.", point: "Lakes, KINTEX, culture and history in one flow", href: "/products", gradientFrom: "#fff6f2", gradientTo: "#ffe7df", chip: "bg-[#ffd9cd] text-[#a34d36]", iconBg: "bg-[#ffd0c0]", iconColor: "text-[#9b3a1a]", glowColor: "rgba(255,143,126,0.5)", icon: ShoppingBag },
      { tag: "MICE", title: "MICE Guide", desc: "Understand how Goyang connects operations and local visitor experiences.", point: "Operations and local connection", href: "/dmc", gradientFrom: "#f0f4ff", gradientTo: "#eef2ff", chip: "bg-[#e1e8ff] text-[#3655a6]", iconBg: "bg-[#d4ddff]", iconColor: "text-[#3655a6]", glowColor: "rgba(100,130,255,0.4)", icon: Compass },
  ...
  ja: {
    eyebrow: "なぜソウルではなく高陽か — 自然・歴史・K-カルチャーが交わる街",
    title: "高陽で出会えるもの",
    viewDetails: "詳細を見る",
    cards: [
      { tag: "Guide", title: "体験・見どころ案内", desc: "旅行商品・宿泊・レストラン・チケット・空港送迎まで高陽の地域情報をひとまとめでご確認いただけます。", point: "湖・KINTEX・文化・歴史を一つの流れで", href: "/products", gradientFrom: "#fff6f2", gradientTo: "#ffe7df", chip: "bg-[#ffd9cd] text-[#a34d36]", iconBg: "bg-[#ffd0c0]", iconColor: "text-[#9b3a1a]", glowColor: "rgba(255,143,126,0.5)", icon: ShoppingBag },
      { tag: "MICE", title: "MICEガイド", desc: "高陽市がイベント運営とローカル体験をどのようにつなぐかをご確認ください。", point: "現場運営とローカル連携", href: "/dmc", gradientFrom: "#f0f4ff", gradientTo: "#eef2ff", chip: "bg-[#e1e8ff] text-[#3655a6]", iconBg: "bg-[#d4ddff]", iconColor: "text-[#3655a6]", glowColor: "rgba(100,130,255,0.4)", icon: Compass },
  ...
  "zh-CN": {
    eyebrow: "为什么是高阳而非首尔 — 自然、历史与K-文化交汇的城市",
    title: "在高阳，将遇见什么",
    viewDetails: "查看详情",
    cards: [
      { tag: "Guide", title: "体验与景点指南", desc: "浏览旅游产品、住宿、餐厅、票务和机场接送——高阳本地信息一览无余。", point: "湖水、KINTEX、文化与历史一气连贯", href: "/products", gradientFrom: "#fff6f2", gradientTo: "#ffe7df", chip: "bg-[#ffd9cd] text-[#a34d36]", iconBg: "bg-[#ffd0c0]", iconColor: "text-[#9b3a1a]", glowColor: "rgba(255,143,126,0.5)", icon: ShoppingBag },
      { tag: "MICE", title: "MICE 指南", desc: "了解高阳市如何连接活动运营与本地访客体验。", point: "现场运营与本地连接", href: "/dmc", gradientFrom: "#f0f4ff", gradientTo: "#eef2ff", chip: "bg-[#e1e8ff] text-[#3655a6]", iconBg: "bg-[#d4ddff]", iconColor: "text-[#3655a6]", glowColor: "rgba(100,130,255,0.4)", icon: Compass },
  ...
  "zh-TW": {
    eyebrow: "為什麼是高陽而非首爾 — 自然、歷史與K-文化交會的城市",
    title: "在高陽，將遇見什麼",
    viewDetails: "查看詳情",
    cards: [
      { tag: "Guide", title: "體驗與景點指南", desc: "瀏覽旅遊產品、住宿、餐廳、票務和機場接送——高陽在地資訊一目瞭然。", point: "湖水、KINTEX、文化與歷史一氣連貫", href: "/products", gradientFrom: "#fff6f2", gradientTo: "#ffe7df", chip: "bg-[#ffd9cd] text-[#a34d36]", iconBg: "bg-[#ffd0c0]", iconColor: "text-[#9b3a1a]", glowColor: "rgba(255,143,126,0.5)", icon: ShoppingBag },
      { tag: "MICE", title: "MICE 指南", desc: "了解高陽市如何連結活動運營與在地訪客體驗。", point: "現場運營與在地連結", href: "/dmc", gradientFrom: "#f0f4ff", gradientTo: "#eef2ff", chip: "bg-[#e1e8ff] text-[#3655a6]", iconBg: "bg-[#d4ddff]", iconColor: "text-[#3655a6]", glowColor: "rgba(100,130,255,0.4)", icon: Compass },
