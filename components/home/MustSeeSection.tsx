// components/home/MustSeeSection.tsx — 오더 #C14b Must-see 4카드.
//
// 사장님 확정 4곳:
//   1) seooreung           — history · UNESCO 스탬프
//   2) ilsan-lake-park     — walk · (스탬프 없음, 앵커성 강)
//   3) kintex              — culture · GTX 스탬프
//   4) starfield-goyang    — shopping · (스탬프 없음)
//
// 데이터:
//   · spots.title / subtitle (5로케일) 재사용
//   · 사진: public/images/spots/{slug}-1.jpg 우선 → hero-{category}.jpg 폴백 → gradient 폴백
