...
const heroCopy: Record<LocaleKey, LocaleCopy> = {
  ko: {
    badgeEyebrow: "서울 옆, 공항 앞",
    badgeTitle: "고양일산에서 만나는 경험",
    cards: [
      ...
      { eyebrow: "Experience", title: "머무르고 이어지는 체류 경험", desc: "카페, 미식, 로컬 체험, 쇼핑 동선을 연결해 고양일산만의 라이프스타일 경험을 확장합니다.", tone: "bg-gradient-to-br from-[#fff5f2] to-[#ffe7df]", iconTone: "bg-[#ffd0c0] text-[#9b3a1a]", borderGlow: "hover:shadow-[0_0_24px_rgba(255,143,126,0.45)]", icon: Sparkles },
    ],
    stats: [
  ...
  en: {
    badgeEyebrow: "Next to Seoul, by the airport",
    badgeTitle: "Experiences you'll find in Goyang-Ilsan",
    cards: [
  ...
  ja: {
    badgeEyebrow: "ソウルの隣、空港のそば",
    badgeTitle: "高陽・一山で出会う体験",
    cards: [
      ...
      { eyebrow: "Experience", title: "滞在が続くライフスタイル体験", desc: "カフェ・グルメ・ローカル体験・ショッピングルートを連結し、高陽・一山独自のライフスタイル体験を拡張します。", tone: "bg-gradient-to-br from-[#fff5f2] to-[#ffe7df]", iconTone: "bg-[#ffd0c0] text-[#9b3a1a]", borderGlow: "hover:shadow-[0_0_24px_rgba(255,143,126,0.45)]", icon: Sparkles },
    ],
    stats: [
  ...
  "zh-CN": {
    badgeEyebrow: "首尔近旁，机场之侧",
    badgeTitle: "在高阳·一山遇见的体验",
    cards: [
      ...
      { eyebrow: "Experience", title: "延续的体验之旅", desc: "连接咖啡馆、美食、本地体验和购物路线，扩展高阳·一山独特的生活方式体验。", tone: "bg-gradient-to-br from-[#fff5f2] to-[#ffe7df]", iconTone: "bg-[#ffd0c0] text-[#9b3a1a]", borderGlow: "hover:shadow-[0_0_24px_rgba(255,143,126,0.45)]", icon: Sparkles },
    ],
    stats: [
  ...
  "zh-TW": {
    badgeEyebrow: "首爾近旁，機場之側",
    badgeTitle: "在高陽·一山遇見的體驗",
    cards: [
      ...
      { eyebrow: "Experience", title: "延續的體驗旅程", desc: "連結咖啡廳、美食、在地體驗與購物路線，擴展高陽·一山獨特的生活風格體驗。", tone: "bg-gradient-to-br from-[#fff5f2] to-[#ffe7df]", iconTone: "bg-[#ffd0c0] text-[#9b3a1a]", borderGlow: "hover:shadow-[0_0_24px_rgba(255,143,126,0.45)]", icon: Sparkles },
    ],
    stats: [
