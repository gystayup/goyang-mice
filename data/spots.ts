    ...
    sections: [
      {
        ...
        body: {
          ...
          en: "At first glance it is an ordinary 40,000-seat stadium, but this venue has emerged as a new mecca for K-POP and global concerts. Top K-pop artists such as BTS, BLACKPINK, G-DRAGON, and DAY6 have played here, and among overseas headliners, Kanye West took a specially built stage in August 2024, followed by Coldplay in April 2025 — Coldplay performed six shows here from April 16 to 25, 2025.\n\nHow did Goyang become the center of big concerts? Jamsil Olympic Stadium, long the venue of choice, went into a major renovation, and Sangam World Cup Stadium and others are hard to book for concerts because of their K League football schedules. Meanwhile, Goyang Stadium seats 40,000, is close to Incheon International Airport, and is served by Daegok Station on Line 3 and Kintex Station on GTX-A — an outstanding location. Above all, Goyang has no home professional football club, which makes using the stadium as a concert venue that much easier.\n\nVisit tips: about a 3-minute walk from Exit 3 of Daehwa Station (Line 3), and close to Kintex Station (GTX-A). If you are coming to Goyang for K-content, check the concert schedule first and plan your day around it.",
          ja: "見た目は4万席規模の平凡な総合競技場ですが、今やここはK-POPとグローバル公演の新たな聖地として台頭しています。BTS・BLACKPINK・G-DRAGON・DAY6などK-POPのトップアーティストがここを訪れ、海外のトップスターとしては2024年8月にカニエ・ウェスト（Kanye West）、2025年4月にコールドプレイ（Coldplay）が特設ステージに立ちました。コールドプレイは2025年4月16日から25日まで、ここで6公演を行いました。\n\nどうして高陽が大型公演の中心地になったのでしょうか。大型公演の定番だったチャムシル（蚕室）総合運動場がリモデリングに入り、サンアム（上岩）ワールドカップ競技場などはプロサッカーの日程で公演場として使いにくい一方、高陽総合運動場は4万席規模で仁川空港にも近く、3号線・大谷（テゴク）駅とGTX-A・キンテックス駅で結ばれ、立地が優れています。何より、高陽にプロサッカーチームがないため、競技場を公演場として使うのに負担が少ないのです。\n\n訪問のヒント：3号線・大化（テファ）駅3番出口から徒歩約3分、GTX-A・キンテックス駅からも近いです。K-コンテンツを見に高陽へ来るなら、まず公演スケジュールを確認して動線を組むのがおすすめです。",
          "zh-CN": "外表看是一座四万席规模的普通综合体育场，如今这里已成为K-POP与全球演唱会的新圣地。BTS、BLACKPINK、G-DRAGON、DAY6等K-POP顶级艺人皆曾登台，海外顶流方面，2024年8月Kanye West、2025年4月Coldplay相继登上特设舞台。Coldplay在2025年4月16日至25日期间于此举行了6场演唱会。\n\n高阳为何成为大型演唱会中心？作为常用大型场地的蚕室综合运动场进入改造期，上岩世界杯竞技场等则因职业足球赛程难以作为演出场地；而高阳综合运动场拥有四万席规模，邻近仁川国际机场，并有3号线大谷站、GTX-A韩国国际展览中心站可达，区位极佳。最重要的是，高阳没有本土职业足球队，将球场用作演出场地的负担较小。\n\n参观提示：从3号线大化站3号出口步行约3分钟，距GTX-A韩国国际展览中心站亦近。若为K-content来到高阳，请先确认演唱会日程再规划行程。",
          "zh-TW": "外表看是一座四萬席規模的普通綜合體育場，如今這裡已成為K-POP與全球演唱會的新聖地。BTS、BLACKPINK、G-DRAGON、DAY6等K-POP頂級藝人皆曾登台，海外頂流方面，2024年8月Kanye West、2025年4月Coldplay相繼登上特設舞台。Coldplay在2025年4月16日至25日期間於此舉行了6場演唱會。\n\n高陽為何成為大型演唱會中心？作為常用大型場地的蠶室綜合運動場進入改造期，上岩世界盃競技場等則因職業足球賽程難以作為演出場地；而高陽綜合運動場擁有四萬席規模，鄰近仁川國際機場，並有3號線大谷站、GTX-A韓國國際展覽中心站可達，區位極佳。最重要的是，高陽沒有本土職業足球隊，將球場用作演出場地的負擔較小。\n\n參觀提示：從3號線大化站3號出口步行約3分鐘，距GTX-A韓國國際展覽中心站亦近。若為K-content來到高陽，請先確認演唱會日程再規劃行程。",
        },
      },
    ], access: [], know: [],
    ...
    sections: [
      {
        ...
        body: {
          ...
          en: "There is a story right in the name. \"One Mount\" is a direct English translation of \"Ilsan (一山)\" — \"il (一) = One, san (山) = Mount.\" But the name \"Ilsan\" itself has a deep history. This land was originally called \"Hanmoe\" in native Korean, meaning \"the great mountain,\" but during the Japanese colonial era, when place names were reorganised, \"han (great)\" was misread as \"hana (one),\" and \"one mountain = Ilsan\" was the result. So One Mount is a name that carries even that old mistranslation with it.\n\nIt is a mixed-use cultural complex built in 2013 next to KINTEX by a Goyang-based company that also created Lafesta and Western Dom, gathering an indoor and outdoor water park, a year-round snow park, and a shopping mall in a single building.\n\nSnow sledding without winter, water play in summer — it makes an ideal day out for families with children. It also has personality-driven food and drink spots rarely seen in Ilsan, such as an SPA-brand store and a taco brewery.",
          ja: "名前からしてストーリーがあります。「One Mount（ワンマウント）」は、「一山（イルサン）」をそのまま英語に直したもの——「一（イル）＝One、山（サン）＝Mount」です。ところが、その「一山」という名自体にも深い由来があります。元々この地は「大きな山」を意味する韓国語「ハンモエ（한뫼）」と呼ばれていましたが、日本統治期の地名整理の際に「ハン（大きい）」が「ハナ（一）」と誤読され、「一つの山＝一山」となってしまいました。つまりワンマウントは、遠い昔の誤訳までもを抱えて生まれた名前なのです。\n\nラフェスタ・ウエスタンドムを手がけた高陽の郷土企業が、キンテックスの隣に2013年に建てた複合文化施設で、屋内外のウォーターパーク、四季雪の降るスノーパーク、ショッピングモールが一つの建物に集まっています。\n\n冬でなくても雪ぞりを楽しめ、夏にも水遊びができるので、お子様連れのファミリーの一日コースにぴったりです。一山では珍しいSPAブランド店やタコの醸造所（Taco Brewery）といった個性的な飲食空間もあります。",
          "zh-CN": "从名字就有故事。「One Mount」是把「一山」直译为英语——「一 (Il) = One，山 (San) = Mount」。而「一山」这个名字本身也另有来历。此地原本以韩语「Hanmoe（한뫼／大山）」——意为「大山」——之名，然日据时期整理地名时，将「Han（大）」误读为「Hana（一）」，结果变成「一座山＝一山」。也就是说，One Mount这个名字诞生时就承载着久远的误译。\n\nOne Mount 由打造了 Lafesta、Western Dom 的高阳本土企业于2013年在 KINTEX 旁建成，室内外水上乐园、四季飘雪的雪世界、购物中心齐聚一栋建筑。\n\n非冬季也能玩雪橇，夏季亦可戏水，是有孩子的家庭一日行程的绝佳去处。此处还有一山少见的SPA品牌店与Taco酿造所等富有个性的餐饮空间。",
          "zh-TW": "從名字就有故事。「One Mount」是把「一山」直譯為英語——「一 (Il) = One，山 (San) = Mount」。而「一山」這個名字本身也另有來歷。此地原本以韓語「Hanmoe（한뫼／大山）」——意為「大山」——之名，然日據時期整理地名時，將「Han（大）」誤讀為「Hana（一）」，結果變成「一座山＝一山」。也就是說，One Mount這個名字誕生時就承載著久遠的誤譯。\n\nOne Mount 由打造了 Lafesta、Western Dom 的高陽本土企業於2013年在 KINTEX 旁建成，室內外水上樂園、四季飄雪的雪世界、購物中心齊聚一棟建築。\n\n非冬季也能玩雪橇，夏季亦可戲水，是有孩子的家庭一日行程的絕佳去處。此處還有一山少見的SPA品牌店與Taco釀造所等富有個性的餐飲空間。",
        },
      },
    ], access: [], know: [],
    ...
    sections: [
      {
        ...
        body: {
          ...
          en: "Starfield Goyang sits at a gateway position linking Seoul and the northwestern Gyeonggi area. Traditional Korean architectural motifs — the natural setting of Bukhansan Mountain, fortress walls, sosul-mun (a raised, high-status gate), watchtowers, and more — are reinterpreted in a contemporary idiom and woven into the building's design. From trendy fashion and beauty specialty halls to a value-priced warehouse-style hypermarket and an upgraded market, a single space lets you enjoy a wide range of shopping and leisure culture in comfort. With Aquafield — a year-round hot-spring bath complex — the latest-equipped cinema, a mixed-play space for children, and a variety of specialised service facilities, the whole family can build precious memories together.\n\n(Source: Starfield Goyang official site)",
          ja: "スターフィールド高陽（Starfield Goyang）は、ソウルと京畿西北部を結ぶ玄関口的な立地にあります。北漢山の美しい自然環境と城郭、ソスルムン（솟을문／格の高い門）、望楼など、古くから受け継がれてきた韓国の建築モチーフを現代的に再解釈し、建築デザインに取り入れています。トレンディなファッション・ビューティー専門館から、リーズナブルな倉庫型ハイパーマーケット、アップグレードされたマーケットまで、一つの空間でショッピングとレジャー・カルチャーを快適にお楽しみいただけます。四季の温泉水を楽しめる「アクアフィールド」、最新設備のシネマ、子どものための複合遊び場、多彩な特化サービス施設まで、ご家族みんなで大切な思い出を作れます。\n\n（出典：スターフィールド高陽公式サイト）",
          "zh-CN": "Starfield 高阳位于连接首尔与京畿西北部的门户位置。将北汉山优美的自然环境与城郭、竖起门（솟을문）、瞭望楼等自古延续的韩国建筑元素以现代方式重新演绎，融入建筑设计之中。从潮流时尚美妆专门馆，到价格合理的仓储式大卖场，再到升级版超市，可在同一空间舒适地享受多样化的购物与休闲文化。四季温泉水的水上乐园Aquafield、最新设施的影院、儿童综合游乐空间与多样的特色服务设施，让全家一同留下珍贵回忆。\n\n（出处：Starfield 高阳官方网站）",
          "zh-TW": "Starfield 高陽位於連接首爾與京畿西北部的門戶位置。將北漢山優美的自然環境與城郭、豎起門（솟을문）、瞭望樓等自古延續的韓國建築元素以現代方式重新演繹，融入建築設計之中。從潮流時尚美妝專門館，到價格合理的倉儲式大賣場，再到升級版超市，可在同一空間舒適地享受多樣化的購物與休閒文化。四季溫泉水的水上樂園Aquafield、最新設施的影院、兒童綜合遊樂空間與多樣的特色服務設施，讓全家一同留下珍貴回憶。\n\n（出處：Starfield 高陽官方網站）",
        },
      },
    ],
    access: [],
    ...
    sections: [
      {
        ...
        body: {
          ...
          en: "Wondang Market in Goyang boasts a long history and tradition, and stands as a representative traditional market of Goyang closely tied to the daily lives of local residents. Amid a downtown filled with modernised hypermarkets and shopping malls, it keeps its old atmosphere and generous spirit intact, buzzing with activity every day. With plenty to see and a friendly mood, it is a market that suits a family visit.",
          ja: "高陽市に位置する元堂（ウォンダン）市場は、長い歴史と伝統を誇り、地域住民の暮らしと密接に結びついた高陽市の代表的な伝統市場です。近代化された大型マートやショッピングモールがひしめく都心の中で、昔ながらの情緒と大らかな人情をそのまま残し、日々活気にあふれて営まれています。見どころも多く、温かい雰囲気があるので、家族と訪れるのに良い市場です。",
          "zh-CN": "位于高阳市的元堂市场，历史悠久、传统深厚，是与当地居民日常生活紧密相连的高阳代表性传统市场。在遍布现代化大卖场与购物中心的市区中，元堂市场依然保留着旧日的风情与浓厚的人情味，每天热闹非凡。看点多、氛围温馨，适合家庭一同前往。",
          "zh-TW": "位於高陽市的元堂市場，歷史悠久、傳統深厚，是與當地居民日常生活緊密相連的高陽代表性傳統市場。在遍布現代化大賣場與購物中心的市區中，元堂市場依然保留著舊日的風情與濃厚的人情味，每天熱鬧非凡。看點多、氛圍溫馨，適合家庭一同前往。",
        },
      },
    ],
    access: [],
    ...
    sections: [
      {
        ...
        body: {
          ...
          en: "Ilsan Furniture District is a large furniture district located in Goyang. With large showrooms selling furniture direct to consumers, many items are offered at discounts, and there are periodic promotional events.\nIt is easy to see and buy in person a wide variety of designs — brand furniture, designer pieces, imported furniture and more. To make selection easier, experts are on hand to advise on how each piece will be used and where to place it.",
          ja: "一山家具団地は、高陽（コヤン）に位置する大規模な家具団地です。大型店舗が入居し、家具を消費者と直接取引する方式で販売しているため、値引き商品が多く、特定期間にはイベントも開催されます。\nブランド家具、デザイナー家具、輸入家具など多彩な種類・デザインの家具を実際に見て購入できるのが強みです。より選びやすいよう、家具の用途や設置場所などを踏まえ、専門家との相談も可能です。",
          "zh-CN": "一山家具园区是位于高阳的大型家具园区。大型商店入驻，采取厂家与消费者直销的方式销售家具，因此优惠商品众多，特定时期还会举办活动。\n可实地查看并选购品牌家具、设计师家具、进口家具等多种类别与设计的家具。为便于挑选，还可根据家具用途、摆放位置等与专业人员进行咨询。",
          "zh-TW": "一山家具園區是位於高陽的大型家具園區。大型商店入駐，採取廠家與消費者直銷的方式銷售家具，因此優惠商品眾多，特定時期還會舉辦活動。\n可實地查看並選購品牌家具、設計師家具、進口家具等多種類別與設計的家具。為便於挑選，還可根據家具用途、擺放位置等與專業人員進行諮詢。",
        },
      },
    ],
    access: [],
    ...
    sections: [
      {
        ...
        body: {
          ...
          en: "The Hyundai Kintex is a premium lifestyle and culture space that adds refinement and ease to customers' lives. Through world-class brands, distinctive cultural programming, and attentive customer service, it delivers value that goes beyond simple shopping.",
          ja: "現代百貨店キンテックス店は、お客様の暮らしに品格と余裕を添えるプレミアム・ライフスタイル文化空間です。世界のハイクラスなブランドと差別化された文化コンテンツ、きめ細やかな顧客サービスを通じて、単なるショッピングを超える価値をお届けします。",
          "zh-CN": "现代百货 KINTEX 店是为顾客生活增添品位与从容的高端生活方式与文化空间。通过全球高端品牌、差异化的文化内容与细致周到的服务，传递超越单纯购物的价值。",
          "zh-TW": "現代百貨 KINTEX 店是為顧客生活增添品味與從容的高端生活方式與文化空間。透過全球高端品牌、差異化的文化內容與細緻周到的服務，傳遞超越單純購物的價值。",
        },
      },
    ],
    access: [],
    ...
    sections: [
      {
        ...
        body: {
          ...
          en: "Aqua Planet Ilsan, located near the Hallyu World development site in Goyang, Gyeonggi-do, is the Seoul metropolitan area's largest aquarium — and, notably, Korea's first aquarium combined with an indoor zoo.\n\nHome to marine and terrestrial creatures from around the world, it lets visitors meet a wide variety of animals in one place, including walruses, ring-tailed lemurs, and hyacinth macaws.\n\nHighlights include mesmerising magic performances in the large-tank Deep Blue Ocean, ecology talks at the Ocean Arena, and Tree Shelter, where visitors meet the animal residents of the jungle — a range of content that combines fun and learning.\n\nSupporting eateries and gift shops are also in operation.",
          ja: "アクアプラネット一山（Aqua Planet Ilsan）は、京畿道高陽の韓流ワールド造成予定地の近くに位置する首都圏最大規模の水族館で、特に韓国国内では初となる、屋内動物園を併設したアクアリウムである点が特徴です。\n\n世界各地から集まった海洋生物・陸上生物が展示されており、セイウチ、ワオキツネザル、スミレコンゴウインコなど多彩な生き物を一度に見ることができます。\n\n特に、大型水槽「ディープ・ブルーオーシャン」での不思議なマジックパフォーマンス、多彩な生態レクチャーが行われる「オーシャン・アリーナ」、ジャングルに暮らす動物たちに会える「木のシェルター」など、楽しさと学びを同時に感じられる多彩なコンテンツに出会えます。\n\nそのほか、飲食店とギフトショップも営業しています。",
          "zh-CN": "水族館 一山（Aqua Planet Ilsan）位于京畿道高阳韩流世界建设用地附近，是首都圈规模最大的水族馆，尤其以韩国首次结合室内动物园的水族馆为特色。\n\n馆内展出来自世界各地的海洋与陆生生物，可一次见到海象、环尾狐猴、紫蓝金刚鹦鹉等多种动物。\n\n更有大型水槽「Deep Blue Ocean」上演的神奇魔术表演、举办各类生态讲解的「Ocean Arena」，以及可近距离接触丛林动物的「树之栖息处（나무 쉼터）」等，兼具趣味与教育的多样内容。\n\n此外，馆内还设有餐饮店与礼品店。",
          "zh-TW": "水族館 一山（Aqua Planet Ilsan）位於京畿道高陽韓流世界建設用地附近，是首都圈規模最大的水族館，尤其以韓國首次結合室內動物園的水族館為特色。\n\n館內展出來自世界各地的海洋與陸生生物，可一次見到海象、環尾狐猴、紫藍金剛鸚鵡等多種動物。\n\n更有大型水槽「Deep Blue Ocean」上演的神奇魔術表演、舉辦各類生態講解的「Ocean Arena」，以及可近距離接觸叢林動物的「樹之棲息處（나무 쉼터）」等，兼具趣味與教育的多樣內容。\n\n此外，館內還設有餐飲店與禮品店。",
        },
      },
    ],
    access: [],
    ...
    sections: [
      {
        ...
        body: {
          ...
          en: "The Children's Observatory was founded to inspire children's interest in space science and to help them dream of the stars and the universe, centred on professional astronomical observation facilities and equipment and astronomical research activities.\n\nTo that end, the Children's Observatory runs regular programmes built around a different theme each month — theory, hands-on making, and celestial observation — along with a range of educational programmes including one-day experiences and family programmes.\n\nBy developing a variety of hands-on, in-depth educational programmes, it aims to offer children more diverse and deeper astronomy and natural-science education services.\n\nStarting with Ilsan Children's Observatory in 2003, there are now 19 branches in the Gyeonggi/Incheon region, 3 in Chungcheong Province, 2 in Gyeongsang Province, and 1 each in Jeolla and Gangwon Special Self-Governing Province, so a Children's Observatory can be found almost anywhere.",
          ja: "こども天文台は、専門的な天体観測施設と機材、天文研究活動を中心に、宇宙科学への関心を子どもたちに呼び起こし、星と宇宙への夢と希望を抱かせるために設立されました。\n\nそのために、毎月異なるテーマで、理論と工作、天体観測などから構成される正規プログラムや、一日体験、ファミリープログラムなど多彩な教育プログラムを運営しています。\n\n体験的で奥行きのある多様な教育プログラムを開発し、子どもたちにより幅広く深みのある天文・自然科学教育サービスを提供しようとしています。\n\n2003年の一山こども天文台を皮切りに、京畿/仁川地域に19拠点、忠清道に3拠点、慶尚道に2拠点、全羅道と江原特別自治道にそれぞれ1拠点があり、どこにいてもこども天文台に出会えます。",
          "zh-CN": "儿童天文台以专业的天体观测设施与设备、天文研究活动为核心，旨在激发儿童对宇宙科学的兴趣与关注，让他们对星辰与宇宙怀抱梦想与希望而设立。\n\n为此，儿童天文台每月围绕不同主题，开设涵盖理论、手工制作、天体观测等的常规项目，以及一日体验、亲子项目等多种教育项目。\n\n通过开发富有体验性、深入性的多样教育项目，致力于为儿童提供更丰富、更深入的天文与自然科学教育服务。\n\n自2003年一山儿童天文台起步以来，京畿/仁川地区已有19家分点，忠清道3家、庆尚道2家，全罗道与江原特别自治道各1家，无论身在何处，都能就近走进儿童天文台。",
          "zh-TW": "兒童天文台以專業的天體觀測設施與設備、天文研究活動為核心，旨在激發兒童對宇宙科學的興趣與關注，讓他們對星辰與宇宙懷抱夢想與希望而設立。\n\n為此，兒童天文台每月圍繞不同主題，開設涵蓋理論、手工製作、天體觀測等的常規項目，以及一日體驗、親子項目等多種教育項目。\n\n透過開發富有體驗性、深入性的多樣教育項目，致力於為兒童提供更豐富、更深入的天文與自然科學教育服務。\n\n自2003年一山兒童天文台起步以來，京畿/仁川地區已有19家分點，忠清道3家、慶尚道2家，全羅道與江原特別自治道各1家，無論身在何處，都能就近走進兒童天文台。",
        },
      },
    ],
    access: [],
