    ...
    return NextResponse.json(
      {
        ...
        data: products.map((product) => ({
          ...
          product_type: product.productType as unknown as Product["product_type"],
          title: product.title,
          slug: product.slug,
          ...
          price_type: product.priceType as unknown as Product["price_type"],
          is_bookable: product.isBookable,
          status: product.status as unknown as Product["status"],
          thumbnail_id: product.thumbnailId,
          lang: product.lang as unknown as Product["lang"],
